...
class GreedyFeeder(Feeder):
    ...
    def feed(self, domains):
        ...
        cnt = 0
        while not self.signal.get('reach_max_num') and 150 > cnt:
            time.sleep(1)
...
class GreedyParser(Parser):
    ...
    def parse(self, response, domains, keywords):
...
class GreedyImageCrawler(Crawler):
    ...
    def crawl(self,
        ...
        super(GreedyImageCrawler, self).crawl(
            ...
            parser_kwargs={'domains': domains, 'keywords': keywords},
